	...
	<article class="container">
		<section>
			...
			<figure id="mapa-localizacao">
				<iframe id="mapa-localizacao" width="425" height="350" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="http://maps.google.com.br/maps?q=Jacarezinho&amp;output=embed"></iframe>
				<figcaption>Localização da Mirror Fashion</figcaption>
			</figure>
		</section>
		<section>
			...
			<figure id="video-apresentacao">
				<iframe id="video-apresentacao" width="420" height="315" src="http://www.youtube.com/embed/Tb06abHE4hY" frameborder="0" allowfullscreen></iframe>
				<figcaption>Vídeo de apresentação da Mirror Fashion</figcaption>
			</figure>
		</section>
		<section>
